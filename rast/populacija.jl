...
##
##
populacija = CSV.read("Populacija_zemlja.csv", DataFrame) # učitamo podatke koje imamo u datoteci, dodajte vlastiti path
show(populacija)
godina=populacija[:,1] 
...
r, Kap=parametri_populacije(0.025,-0.0018)
predikcija=model_4(vrijeme_poc,3000,populacija[1,2], r, Kap)
godine=1950:1:3000
